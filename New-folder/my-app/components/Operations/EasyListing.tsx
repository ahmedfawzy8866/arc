          ...
          >
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className="w-full bg-slate-50/50 border border-slate-200 rounded-full h-14 pl-14 pr-6 outline-none focus:ring-2 focus:ring-gold text-sm font-bold"
                    />
                  </div>
                </div>
            ...
            <section className="lg:col-span-3 space-y-6">
              <div className="glass-panel p-8 bg-navy text-white relative overflow-hidden group">
                <div className="absolute top-0 right-0 w-32 h-32 bg-gold/10 rounded-full blur-3xl -mr-16 -mt-16 transition-transform group-hover:scale-150 duration-700" />
        ...
        <div className="p-8 border-b border-slate-100 flex flex-col md:flex-row justify-between items-center gap-6 bg-white/30">
          ...
          <div className="relative w-full md:w-96">
            ...
            <input 
              ...
              className="w-full bg-white/70 border border-slate-200 rounded-full py-3 pl-12 pr-6 outline-none focus:ring-2 focus:ring-gold text-sm"
            />
          </div>
        </div>
