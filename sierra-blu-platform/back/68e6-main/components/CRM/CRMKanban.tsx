...
export default function CRMKanban() {
  ...
  useEffect(() => {
    ...
    if (userProfile?.role === 'agent') {
       ...
       // agent-scoped view: client-side filter applied below
    }
  ...
  const syncLeadsFromPF = async () => {
    ...
    try {
      ...
      const message = `Property Finder sync completed. Added ${summary.created}, refreshed ${summary.updated}, skipped ${summary.skipped}.`;
      alert(message);
    } catch (err) {
      ...
      <div className="page-header">
        <div className="header-flex">
          <div>
            ...
            <div className="page-sub">Showing {visibleStakeholders.length} of {activeInventorySize} stakeholders</div>
          </div>
