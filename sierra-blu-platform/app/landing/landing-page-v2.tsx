      ...
      <section id="sierra" className="sb-ai-section">
        <div className="sb-ai-grid">
          <div className="sb-ai-left">
            ...
            <a href={SBR_CONFIG.telegramUrl} target="_blank" rel="noopener noreferrer" className="sb-ai-btn reveal">
      ...
      <footer className="sb-footer">
        <div className="sb-footer-grid">
          ...
          {[
            ...
            { title: ar ? "تواصل" : "Contact", links: [{ en: SBR_CONFIG.phone, ar: SBR_CONFIG.phone }, { en: SBR_CONFIG.email, ar: SBR_CONFIG.email }, { en: "New Cairo, Egypt", ar: "التجمع الخامس، مصر" }] },
          ].map((col) => (
            <div key={col.title}>
