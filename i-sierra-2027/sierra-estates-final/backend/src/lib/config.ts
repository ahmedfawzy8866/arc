...
/**
 * Server-side runtime config (site URL for absolute links in alerts/emails, etc.)
 */
export const SE_CONFIG = {
  siteUrl: process.env.NEXT_PUBLIC_SITE_URL || process.env.SITE_URL || 'https://sierraestates.com',
};
